...
/////////  
   ...
   Bool_t          fPrtcls_IsPi0Photon[kMaxfPrtcls];   //[fPrtcls_]
   Bool_t          fPrtcls_IsJetFlavor[kMaxfPrtcls];   //[fPrtcls_]
   Bool_t          fPrtcls_IsExcitedState[kMaxfPrtcls];   //[fPrtcls_]
   ...
   TBranch        *b_fPrtcls_IsPi0Photon;   //!
   TBranch        *b_fPrtcls_IsJetFlavor;   //!
   TBranch        *b_fPrtcls_IsExcitedState;   //!
