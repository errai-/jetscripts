...
class ProfileProjector
{
  ...
  // A function which gives a plot of pt or eta distribution of the jets
  // for a given range of eta or pt
  ...
  // Does the desired projection; a bit clumsy in order to avoid repetitive
  // names
