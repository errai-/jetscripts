...
// Wed Jun 11 12:12:23 2014 by ROOT version 5.34/18
// from TTree ProcessedTree/ProcessedTree
// found on file: Data_3rdSeptember_Run2012A.root
//////////////////////////////////////////////////////////
...
const Int_t kMaxCaloJets_ = 85;
const Int_t kMaxCaloJets__genR = 85;
const Int_t kMaxCaloJets__cor = 85;
const Int_t kMaxCaloJets__unc = 85;
const Int_t kMaxCaloJets__uncSrc = 85;
const Int_t kMaxCaloJets__area = 85;
const Int_t kMaxCaloJets__looseID = 85;
const Int_t kMaxCaloJets__tightID = 85;
const Int_t kMaxCaloJets__emf = 85;
const Int_t kMaxCaloJets__fHPD = 85;
const Int_t kMaxCaloJets__fRBX = 85;
const Int_t kMaxCaloJets__n90hits = 85;
const Int_t kMaxCaloJets__nTrkCalo = 85;
const Int_t kMaxCaloJets__nTrkVtx = 85;
const Int_t kMaxPFJets_ = 87;
const Int_t kMaxPFJets__genR = 87;
const Int_t kMaxPFJets__cor = 87;
const Int_t kMaxPFJets__unc = 87;
const Int_t kMaxPFJets__uncSrc = 87;
const Int_t kMaxPFJets__area = 87;
const Int_t kMaxPFJets__looseID = 87;
const Int_t kMaxPFJets__tightID = 87;
const Int_t kMaxPFJets__chf = 87;
const Int_t kMaxPFJets__nhf = 87;
const Int_t kMaxPFJets__phf = 87;
const Int_t kMaxPFJets__elf = 87;
const Int_t kMaxPFJets__muf = 87;
const Int_t kMaxPFJets__hf_hf = 87;
const Int_t kMaxPFJets__hf_phf = 87;
const Int_t kMaxPFJets__hf_hm = 87;
const Int_t kMaxPFJets__hf_phm = 87;
const Int_t kMaxPFJets__chm = 87;
const Int_t kMaxPFJets__nhm = 87;
const Int_t kMaxPFJets__phm = 87;
const Int_t kMaxPFJets__elm = 87;
const Int_t kMaxPFJets__mum = 87;
const Int_t kMaxPFJets__ncand = 87;
const Int_t kMaxPFJets__beta = 87;
const Int_t kMaxPFJets__betaStar = 87;
...
public :
 ...
 //vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> > > > L1Obj_;
   ...
   AnalyzeData(TTree *tree=0, Long64_t loopNumber=0, Int_t mc=0, Int_t tests=0);
   virtual ~AnalyzeData();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(string writeFile);
...
AnalyzeData::AnalyzeData(TTree *tree, Long64_t loopNumber, Int_t mc, Int_t tests) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Data_3rdSeptember_Run2012A.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Data_3rdSeptember_Run2012A.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Data_3rdSeptember_Run2012A.root:/ak5");
      dir->GetObject("ProcessedTree",tree);
   }
   loopLimit=loopNumber;
   isMC=mc;
   isDT=!isMC;
   testing=tests;
   Init(tree);
...
Int_t AnalyzeData::Cut(__attribute__((unused)) Long64_t entry)
{
