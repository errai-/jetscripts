...
void OneCompare(Int_t gen1 = 0, Int_t gen2 = 1)
{
    ...
    files[3] = "/home/hannu/Cern/jet_analysis/simulation_analysis/flavour/sim_dir/cteq6l1/herwig_Zjet_physics_1000000.root";
    files[4] = "/home/hannu/Cern/jet_analysis/simulation_analysis/flavour/sim_dir/cteq6l1/herwig_gammajet_physics_1000000.root";
    files[5] = "/home/hannu/Cern/jet_analysis/simulation_analysis/flavour/sim_dir/cteq6l1/herwig_dijet_physics_1000000.root";
    files[6] = "/home/hannu/Cern/jet_analysis/simulation_analysis/flavour/sim_dir/cteq6l1/pythia6_Zjet_physics_1000000.root";
    files[7] = "/home/hannu/Cern/jet_analysis/simulation_analysis/flavour/sim_dir/cteq6l1/pythia6_gammajet_physics_1000000.root";
    files[8] = "/home/hannu/Cern/jet_analysis/simulation_analysis/flavour/sim_dir/cteq6l1/pythia6_dijet_physics_1000000.root";
    ...
    for(std::size_t gen=0; gen != 2; ++gen) {
	    ...
	    for(std::size_t q=0; q != 3; ++q) { //loop over files of one generator
	    	std::stringstream tmpString("");
	    	tmpString << files[3*gen+q];
	    	...
	    	for(unsigned int x=0; x != N; ++x)
	    	{
                ...
                for (int i = 0; i < fJets_; ++i) {
	    		    ...
	    		    if(fFlav[i] == 21) {
	    			    one_gen[0][0]->Fill(fSigma2[i],fWeight);
	    			    one_gen[0][1]->Fill(fPTD[i],fWeight);
	    			    one_gen[0][2]->Fill(fConstituents[i],fWeight);
	    		    } else if(fFlav[i] <= 0) {
	    			    one_gen[2][0]->Fill(fSigma2[i],fWeight);
	    			    one_gen[2][1]->Fill(fPTD[i],fWeight);
	    			    one_gen[2][2]->Fill(fConstituents[i],fWeight);
	    		    } else {
	    			    one_gen[1][0]->Fill(fSigma2[i],fWeight);
	    			    one_gen[1][1]->Fill(fPTD[i],fWeight);
	    			    one_gen[1][2]->Fill(fConstituents[i],fWeight);
	    		    }
                }
	    	}
	    }
	    plots.push_back(one_gen);
    }
