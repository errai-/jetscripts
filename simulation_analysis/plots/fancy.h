...
#ifdef Fancy_cxx
Fancy::Fancy(TTree *tree) : fChain(0) 
{
...
Int_t Fancy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Fancy::LoadTree(Long64_t entry)
{
...
void Fancy::Show(Long64_t entry)
{
...
Int_t Fancy::Cut(Long64_t entry)
{
